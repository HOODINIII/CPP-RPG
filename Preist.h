...
class Preist : public hp, public statblock, public Levelling
{
public:
	static const hptype BaseHP = 100u;				//using static constant to only intentiate once no matter the number of Preist.
	...
	Preist() : hp(BaseHP, BaseHP), statblock(basedmg, baseintel)	//each Preist will start with similar stats
	{
